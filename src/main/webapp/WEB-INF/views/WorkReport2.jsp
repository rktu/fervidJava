...
$("#jqGrid").jqGrid({
            ...
            $('#jqGrid').navGrid('#jqGridPager', { edit: true, add: true, del: false, search: true, refresh: true, },
            {
            	beforeShowForm: function(form) {
                    $('#createdBy', form).attr("disabled", true);
...
<script type="text/javascript">
	...
	if (data == '')
		return;
	JSONToCSVConvertor(data, "WorkReport Report", true);
}
	$(document).ready(function() {
		reloadDataExport();
	});
